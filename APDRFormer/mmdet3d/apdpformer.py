...
class APDPFormerDetector(MVXTwoStageDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(APDPFormerDetector, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def extract_img_feat(self, img, img_metas):
        ...
        if self.with_img_backbone and img is not None:
            ...
            # [12, 192, 48, 132]、[12, 384, 24, 66]、[12, 768, 12, 33]
        else:
            return None
    ...
    def extract_pts_feat(self, pts, img_feats, img_metas, **kwargs):
        ...
        x, img_spec, pts_spec, ins_heatmap,ins_heatmap_img,ins_heatmap_pts, multistage_masks = self.isfusion(pts, x, img_feats, img_metas, batch_size, **kwargs)

        if self.with_pts_neck:
            x = self.pts_neck(x)

        if self.training:
            return [x[0], img_spec, pts_spec], ins_heatmap,ins_heatmap_img,ins_heatmap_pts, multistage_masks
        else:
            return [x[0], img_spec, pts_spec]
            #return [x[0], img_spec, pts_spec], ins_heatmap, ins_heatmap_img, ins_heatmap_pts, multistage_masks
    ...
    def forward_pts_train(self,
        ...
        if len(pts_feats) == 5:
            ...
            loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs, pts_feats[1], pts_feats[2], pts_feats[3], pts_feats[4]]
        else:
    ...
    def simple_test_pts(self, x, x_img, img_metas, rescale=False):
        ...
        # preds_dict = outs[0][0]
        # heatmap = preds_dict["dense_heatmap"]
